...
public:
    ...
    void initializeGraspPoses() 
    {
        ...
        left_grasp_pose.hand_side = 0;
        left_grasp_pose.hand_reset = 1;
        left_grasp_pose.pose_req.position.x = L_grasp_pose[0]+result(0);
        left_grasp_pose.pose_req.position.y = L_grasp_pose[1]+result(1);
        left_grasp_pose.pose_req.position.z = L_grasp_pose[2]+result(2);
