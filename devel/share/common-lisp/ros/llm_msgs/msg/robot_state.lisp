...
(cl:defmethod cl:initialize-instance :after ((m <robot_state>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'robot_state)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name llm_msgs-msg:<robot_state> is deprecated: use llm_msgs-msg:robot_state instead.")))
...
(cl:defmethod head_pose-val ((m <robot_state>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader llm_msgs-msg:head_pose-val is deprecated.  Use llm_msgs-msg:head_pose instead.")
  (head_pose m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <robot_state>) ostream)
  ...
  (cl:let ((__ros_arr_len (cl:length (cl:slot-value msg 'head_pose))))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <robot_state>) istream)
  ...
  (cl:setf (cl:slot-value msg 'head_pose) (cl:make-array __ros_arr_len))
  (cl:let ((vals (cl:slot-value msg 'head_pose)))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<robot_state>)))
  ...
  (cl:format cl:nil "std_msgs/Header header~%~%# 头部姿态数据~%float64[] head_pose #X, Y, Z, R, P, Y~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'robot_state)))
  "Returns full string definition for message of type 'robot_state"
  (cl:format cl:nil "std_msgs/Header header~%~%# 头部姿态数据~%float64[] head_pose #X, Y, Z, R, P, Y~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <robot_state>))
  (cl:+ 0
     ...
     4 (cl:reduce #'cl:+ (cl:slot-value msg 'head_pose) :key #'(cl:lambda (ele) (cl:declare (cl:ignorable ele)) (cl:+ 8)))
))
