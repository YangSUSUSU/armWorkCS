...
if("TRUE" STREQUAL "TRUE")
  set(trac_ik_examples_SOURCE_PREFIX /home/nikoo/workWS/armWorkCS/src/trac_ik/trac_ik_examples)
  set(trac_ik_examples_DEVEL_PREFIX /home/nikoo/workWS/armWorkCS/devel)
  ...
  set(trac_ik_examples_INSTALL_PREFIX /home/nikoo/workWS/armWorkCS/install)
...
if(NOT "/usr/local/include;/usr/share/orocos_kdl/cmake/../../../include;/usr/include/eigen3 " STREQUAL " ")
  set(trac_ik_examples_INCLUDE_DIRS "")
  set(_include_dirs "/usr/local/include;/usr/share/orocos_kdl/cmake/../../../include;/usr/include/eigen3")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'trac_ik_examples' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/nikoo/workWS/armWorkCS/src/trac_ik/trac_ik_examples/${idir}'.  ${_report}")
    endif()
    _list_append_unique(trac_ik_examples_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "/usr/local/lib/libboost_date_time.so.1.77.0;orocos-kdl;nlopt")
